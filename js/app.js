(() => {
    ...
    function script_location() {
        ...
        const newLocation = document.querySelector(".menu__new-location-tel");
        let cloneLocation = location.cloneNode(true);
        cloneLocation.classList.add("newloc");
        newLocation.appendChild(cloneLocation);
        const location2 = document.querySelector(".header__title");
        const newLocation2 = document.querySelector(".menu__new-location-title");
        let cloneLocation2 = location2.cloneNode(true);
        cloneLocation2.classList.add("newloc2");
        newLocation2.appendChild(cloneLocation2);
    }
    script_location();
    window["FLS"] = true;
    isWebp();
